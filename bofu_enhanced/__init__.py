...
bl_info = {
    ...
    "version": (3, 3, 4),
    "blender": (4, 2, 0),
    "location": "View3D > ` 键或鼠标侧键呼出饼图菜单, 长按 Tab 直接进入顶点/边/面编辑模式, Ctrl+M, Ctrl+F, Ctrl+Alt+M",
    "description": "批量导出OBJ文件，高精度变换显示，批量材质管理，增强镜像功能，名称批量替换，饼图快捷菜单，建模模式饼图，智能测量标注，机构运动学求解器，所见即所得视口渲染，一键模型优化",
    "warning": "",
    "doc_url": "",
    "tracker_url": "",
    "category": "3D View",
